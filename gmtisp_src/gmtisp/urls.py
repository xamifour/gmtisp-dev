...
if os.environ.get('SAMPLE_APP', False):
    ...
    # of these values
    from .gmtisp_radius.api import views as api_views
    from .gmtisp_radius.saml import views as saml_views
    from .gmtisp_radius.social import views as social_views
