...
if os.environ.get('MONITORING_INTEGRATION', False):
    ...
    ASGI_APPLICATION = 'gmtisp.routing.application'
    if TESTING:
        CHANNEL_LAYERS = {
...
AUTH_USER_MODEL = 'gmtisp_users.User'
OPENWISP_USERS_GROUP_MODEL = 'gmtisp_users.Group'
OPENWISP_USERS_ORGANIZATION_MODEL = 'gmtisp_users.Organization'
OPENWISP_USERS_ORGANIZATIONUSER_MODEL = 'gmtisp_users.OrganizationUser'
OPENWISP_USERS_ORGANIZATIONOWNER_MODEL = 'gmtisp_users.OrganizationOwner'
OPENWISP_USERS_ORGANIZATIONINVITATION_MODEL = 'gmtisp_users.OrganizationInvitation'
OPENWISP_RADIUS_RADIUSREPLY_MODEL = 'gmtisp_radius.RadiusReply'
OPENWISP_RADIUS_RADIUSGROUPREPLY_MODEL = 'gmtisp_radius.RadiusGroupReply'
OPENWISP_RADIUS_RADIUSCHECK_MODEL = 'gmtisp_radius.RadiusCheck'
OPENWISP_RADIUS_RADIUSGROUPCHECK_MODEL = 'gmtisp_radius.RadiusGroupCheck'
OPENWISP_RADIUS_RADIUSACCOUNTING_MODEL = 'gmtisp_radius.RadiusAccounting'
OPENWISP_RADIUS_NAS_MODEL = 'gmtisp_radius.Nas'
OPENWISP_RADIUS_RADIUSUSERGROUP_MODEL = 'gmtisp_radius.RadiusUserGroup'
OPENWISP_RADIUS_REGISTEREDUSER_MODEL = 'gmtisp_radius.RadiusUserGroup'
OPENWISP_RADIUS_RADIUSPOSTAUTH_MODEL = 'gmtisp_radius.RadiusPostAuth'
OPENWISP_RADIUS_RADIUSBATCH_MODEL = 'gmtisp_radius.RadiusBatch'
OPENWISP_RADIUS_RADIUSGROUP_MODEL = 'gmtisp_radius.RadiusGroup'
OPENWISP_RADIUS_RADIUSTOKEN_MODEL = 'gmtisp_radius.RadiusToken'
OPENWISP_RADIUS_PHONETOKEN_MODEL = 'gmtisp_radius.PhoneToken'
OPENWISP_RADIUS_REGISTEREDUSER_MODEL = 'gmtisp_radius.RegisteredUser'
OPENWISP_RADIUS_ORGANIZATIONRADIUSSETTINGS_MODEL = (
    'gmtisp_radius.OrganizationRadiusSettings'
)
